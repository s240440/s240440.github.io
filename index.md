...
<div class="l-page">
  <iframe src="{{ '/assets/plotly/breweries_per_area.html' | relative_url }}" frameborder='0' scrolling='no' height="auto;" width="100%" style="border: 0px;"></iframe>
</div>
...
<div class="l-page">
  <iframe src="{{ '/assets/plotly/choropleth.html' | relative_url }}" frameborder='0' scrolling='no' height="auto;" width="100%" style="border: 0px;"></iframe>
</div>
